...
\else
\documentclass[french,twoside,draft,twocolumn,landscape]{article}
\usepackage[a4paper,includeheadfoot,headsep=1em,top=1.2cm,bottom=1.2cm
,left=1.2cm,right=1.2cm,footskip=0pt]{geometry}
\fi
\input{header_common}
...
\newtcbtheorem{exercice}{Exercice}{%
  ...
  lowerbox=ignored, code={\tcbset{label={exer-\thetcbcounter}}},%
  % height fill={%
  %   \ifwacom%
  %   true%
  %   \else%
...
\fancypagestyle{ex}{
  ...
  \fancyfoot[C]{\ifwacom\else\thepage/%
    \getpagerefnumber{subjectlastpage}\fi%
  }
