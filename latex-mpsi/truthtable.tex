...
\pgfkeysdefnargs{/truthtbl/expr}{2}{%
  ...
  \pgfkeyssetvalue{/truthtbl/exprargs}{#1}
  \ifcase\countInlineItems{#1}\relax%
  \pgfkeysdefargs{/truthtbl/evalexpr}{}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3,##4}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3,##4,##5}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3,##4,##5,##6}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3,##4,##5,##6,##7}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{##1,##2,##3,##4,##5,##6,##7,##8}{#2}%
  \or%
  \pgfkeysdefargs{/truthtbl/evalexpr}{%
    ##1,##2,##3,##4,##5,##6,##7,##8,##9}{#2}%
  \else%
...
\def\drawthruthtable#1{%
  ...
  \unless\ifnum \X>\truthtbl@exprnbrargs
  \repeat
  \edef\truthtbl@header{\truthtbl@header|c}
  % Create each line.
  \gdef\@joinwithdblbackslash##1{%
    ##1\gdef\@joinwithdblbackslash####1{ \\ ####1}}
  \def\pp##1{%
    \@joinwithdblbackslash{%
      \replcommaswithamps{##1}&\pgfqkeys{/truthtbl}{evalexpr={##1}}}}
  \expandafter\tabular\expandafter{\truthtbl@header}
  \replcommaswithamps{\truthtbl@exprargs} & \replcommaswithamps{\truthtbl@exprname} \\ \hline
  \forlistloop{\pp}{\thruthtbl@allvalues}
  \endtabular
}
